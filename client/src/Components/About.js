    ...
    return (
        <Box>
            ...
            <Box className={classes.wrapper}>
                <Typography variant="h3" style={{ fontFamily: "'Grand Hotel', cursive" }}> CSE SIMPLIFIER </Typography>
                ...
                <Typography variant="h5" className={classes.text}>
                    ...
                    <Box component="span" style={{ marginLeft: 5 }}>
                        ...
                        or send me an Email 
                        <Link href="mailto:shovanaich611@gmail.com?Subject=This is a subject" target="_blank" color="inherit">
                            <Email />
                        </Link>.
                </Typography>
            </Box>
